const TOOLS = {"contrast-checker": {"title": "Contrast Checker", "desc": "Check contrast ratio between foreground and background colors.", "category": "Visual", "kind": "contrast", "fields": [{"id": "fg", "label": "Text color", "type": "text", "value": "#172018"}, {"id": "bg", "label": "Background color", "type": "text", "value": "#fffdf4"}], "manual": false}, "alt-text-checker": {"title": "Alt Text Length Checker", "desc": "Review alt text length, empty text, and descriptive risk.", "category": "Content", "kind": "altText", "fields": [{"id": "text", "label": "Alt text", "type": "textarea", "value": "A person using a laptop on a wooden desk"}], "manual": false}, "heading-structure-checker": {"title": "Heading Structure Checker", "desc": "Extract headings from pasted HTML and flag skipped levels.", "category": "HTML Checks", "kind": "headingCheck", "fields": [{"id": "html", "label": "HTML", "type": "textarea", "value": "<h1>Page title</h1><h2>Section</h2><h3>Detail</h3>"}], "manual": false}, "link-text-checker": {"title": "Link Text Checker", "desc": "Find vague link text such as click here or read more.", "category": "Content", "kind": "linkText", "fields": [{"id": "html", "label": "HTML", "type": "textarea", "value": "<a href='/'>Click here</a><a href='/pricing'>View pricing</a>"}], "manual": false}, "form-label-checker": {"title": "Form Label Checker", "desc": "Estimate whether inputs in pasted HTML have labels or aria-labels.", "category": "HTML Checks", "kind": "formLabels", "fields": [{"id": "html", "label": "HTML", "type": "textarea", "value": "<label>Email <input type='email'></label><input type='text'>"}], "manual": false}, "tap-target-checker": {"title": "Tap Target Size Checker", "desc": "Check tap target size against common 44px guidance.", "category": "Interaction", "kind": "tapTarget", "fields": [{"id": "width", "label": "Width px", "type": "number", "value": 40}, {"id": "height", "label": "Height px", "type": "number", "value": 36}], "manual": false}, "readability-checker": {"title": "Plain Language Readability Checker", "desc": "Estimate reading ease for accessible content.", "category": "Content", "kind": "readability", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Accessibility improves usability for everyone. Clear writing helps people understand content faster."}], "manual": false}, "aria-label-helper": {"title": "ARIA Label Helper", "desc": "Generate example aria-label text for buttons and icon links.", "category": "HTML Checks", "kind": "ariaHelper", "fields": [{"id": "action", "label": "Action", "type": "text", "value": "Open navigation menu"}, {"id": "element", "label": "Element", "type": "select", "value": "", "options": [["button", "Button"], ["link", "Link"], ["input", "Input"]]}], "manual": false}, "focus-order-notes": {"title": "Focus Order Checklist", "desc": "Create a keyboard focus order review checklist.", "category": "Interaction", "kind": "focusChecklist", "fields": [{"id": "components", "label": "Interactive components", "type": "textarea", "value": "Header menu\nSearch input\nMain call to action\nFooter links"}], "manual": false}, "color-blindness-notes": {"title": "Color Meaning Checker", "desc": "Check whether instructions rely only on color meaning.", "category": "Visual", "kind": "colorMeaning", "fields": [{"id": "text", "label": "Instruction text", "type": "textarea", "value": "Click the green button to continue and the red button to cancel."}], "manual": false}, "image-accessibility-checklist": {"title": "Image Accessibility Checklist", "desc": "Generate an image accessibility review checklist.", "category": "Content", "kind": "imageA11y", "fields": [{"id": "purpose", "label": "Image purpose", "type": "select", "value": "", "options": [["informative", "Informative"], ["decorative", "Decorative"], ["functional", "Functional"]]}, {"id": "context", "label": "Context", "type": "text", "value": "Product feature screenshot"}], "manual": false}, "keyboard-checklist": {"title": "Keyboard Navigation Checklist", "desc": "Generate a keyboard navigation test checklist.", "category": "Interaction", "kind": "keyboardChecklist", "fields": [{"id": "page", "label": "Page or component name", "type": "text", "value": "Pricing page"}], "manual": false}, "button-label-checker": {"title": "Button Label Checker", "desc": "Review button and icon-button labels for clarity and accessibility.", "category": "Content", "kind": "ariaHelper", "fields": [{"id": "action", "label": "Button action", "type": "text", "value": "Save invoice as PDF"}, {"id": "element", "label": "Element", "type": "select", "value": "button", "options": [["button", "Button"], ["link", "Link"], ["input", "Input"]]}], "manual": false}, "icon-button-aria-helper": {"title": "Icon Button ARIA Helper", "desc": "Generate action-focused aria-label examples for icon-only buttons.", "category": "HTML Checks", "kind": "ariaHelper", "fields": [{"id": "action", "label": "Action", "type": "text", "value": "Open search filters"}, {"id": "element", "label": "Element", "type": "select", "value": "button", "options": [["button", "Button"], ["link", "Link"], ["input", "Input"]]}], "manual": false}, "modal-focus-checklist": {"title": "Modal Focus Checklist", "desc": "Create a keyboard focus checklist for modal dialogs and overlays.", "category": "Interaction", "kind": "focusChecklist", "fields": [{"id": "components", "label": "Interactive components", "type": "textarea", "value": "Open modal button\nDialog close button\nPrimary action\nSecondary action"}], "manual": false}, "form-accessibility-checker": {"title": "Form Accessibility Checker", "desc": "Estimate whether pasted form HTML has labels or accessible names.", "category": "HTML Checks", "kind": "formLabels", "fields": [{"id": "html", "label": "HTML", "type": "textarea", "value": "<label>Name <input type='text'></label><input type='email' aria-label='Email'>"}], "manual": false}, "image-alt-purpose-helper": {"title": "Image Alt Purpose Helper", "desc": "Create a review checklist for decorative, informative, or functional images.", "category": "Content", "kind": "imageA11y", "fields": [{"id": "purpose", "label": "Image purpose", "type": "select", "value": "informative", "options": [["informative", "Informative"], ["decorative", "Decorative"], ["functional", "Functional"]]}, {"id": "context", "label": "Context", "type": "text", "value": "Checkout success illustration"}], "manual": false}, "mobile-tap-size-checker": {"title": "Mobile Tap Size Checker", "desc": "Check tap target width and height against common mobile guidance.", "category": "Interaction", "kind": "tapTarget", "fields": [{"id": "width", "label": "Width px", "type": "number", "value": 44}, {"id": "height", "label": "Height px", "type": "number", "value": 44}], "manual": false}, "page-heading-outline-checker": {"title": "Page Heading Outline Checker", "desc": "Extract headings from pasted HTML and flag skipped heading levels.", "category": "HTML Checks", "kind": "headingCheck", "fields": [{"id": "html", "label": "HTML", "type": "textarea", "value": "<h1>Dashboard</h1><h2>Reports</h2><h3>Revenue</h3>"}], "manual": false}, "accessible-link-label-checker": {"title": "Accessible Link Label Checker", "desc": "Find vague link text such as click here, read more, and learn more.", "category": "Content", "kind": "linkText", "fields": [{"id": "html", "label": "HTML", "type": "textarea", "value": "<a href='/pricing'>View pricing</a><a href='/docs'>Read more</a>"}], "manual": false}, "advanced-contrast-checker": {"title": "Advanced Contrast Checker", "desc": "Check contrast ratio between foreground and background colors. Use this focused variant for advanced workflows and long-tail search scenarios.", "category": "Visual", "kind": "contrast", "fields": [{"id": "fg", "label": "Text color", "type": "text", "value": "#172018"}, {"id": "bg", "label": "Background color", "type": "text", "value": "#fffdf4"}], "manual": false}, "quick-alt-text-checker": {"title": "Quick Alt Text Length Checker", "desc": "Review alt text length, empty text, and descriptive risk. Use this focused variant for quick workflows and long-tail search scenarios.", "category": "Content", "kind": "altText", "fields": [{"id": "text", "label": "Alt text", "type": "textarea", "value": "A person using a laptop on a wooden desk"}], "manual": false}, "planning-heading-structure-checker": {"title": "Planning Heading Structure Checker", "desc": "Extract headings from pasted HTML and flag skipped levels. Use this focused variant for planning workflows and long-tail search scenarios.", "category": "HTML Checks", "kind": "headingCheck", "fields": [{"id": "html", "label": "HTML", "type": "textarea", "value": "<h1>Page title</h1><h2>Section</h2><h3>Detail</h3>"}], "manual": false}, "mobile-link-text-checker": {"title": "Mobile Link Text Checker", "desc": "Find vague link text such as click here or read more. Use this focused variant for mobile workflows and long-tail search scenarios.", "category": "Content", "kind": "linkText", "fields": [{"id": "html", "label": "HTML", "type": "textarea", "value": "<a href='/'>Click here</a><a href='/pricing'>View pricing</a>"}], "manual": false}, "small-business-form-label-checker": {"title": "Small Business Form Label Checker", "desc": "Estimate whether inputs in pasted HTML have labels or aria-labels. Use this focused variant for small business workflows and long-tail search scenarios.", "category": "HTML Checks", "kind": "formLabels", "fields": [{"id": "html", "label": "HTML", "type": "textarea", "value": "<label>Email <input type='email'></label><input type='text'>"}], "manual": false}, "creator-tap-target-checker": {"title": "Creator Tap Target Size Checker", "desc": "Check tap target size against common 44px guidance. Use this focused variant for creator workflows and long-tail search scenarios.", "category": "Interaction", "kind": "tapTarget", "fields": [{"id": "width", "label": "Width px", "type": "number", "value": 40}, {"id": "height", "label": "Height px", "type": "number", "value": 36}], "manual": false}, "student-readability-checker": {"title": "Student Plain Language Readability Checker", "desc": "Estimate reading ease for accessible content. Use this focused variant for student workflows and long-tail search scenarios.", "category": "Content", "kind": "readability", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Accessibility improves usability for everyone. Clear writing helps people understand content faster."}], "manual": false}, "team-aria-label-helper": {"title": "Team ARIA Label Helper", "desc": "Generate example aria-label text for buttons and icon links. Use this focused variant for team workflows and long-tail search scenarios.", "category": "HTML Checks", "kind": "ariaHelper", "fields": [{"id": "action", "label": "Action", "type": "text", "value": "Open navigation menu"}, {"id": "element", "label": "Element", "type": "select", "value": "", "options": [["button", "Button"], ["link", "Link"], ["input", "Input"]]}], "manual": false}, "audit-focus-order-notes": {"title": "Audit Focus Order Checklist", "desc": "Create a keyboard focus order review checklist. Use this focused variant for audit workflows and long-tail search scenarios.", "category": "Interaction", "kind": "focusChecklist", "fields": [{"id": "components", "label": "Interactive components", "type": "textarea", "value": "Header menu\nSearch input\nMain call to action\nFooter links"}], "manual": false}, "checklist-color-blindness-notes": {"title": "Checklist Color Meaning Checker", "desc": "Check whether instructions rely only on color meaning. Use this focused variant for checklist workflows and long-tail search scenarios.", "category": "Visual", "kind": "colorMeaning", "fields": [{"id": "text", "label": "Instruction text", "type": "textarea", "value": "Click the green button to continue and the red button to cancel."}], "manual": false}, "campaign-image-accessibility-checklist": {"title": "Campaign Image Accessibility Checklist", "desc": "Generate an image accessibility review checklist. Use this focused variant for campaign workflows and long-tail search scenarios.", "category": "Content", "kind": "imageA11y", "fields": [{"id": "purpose", "label": "Image purpose", "type": "select", "value": "", "options": [["informative", "Informative"], ["decorative", "Decorative"], ["functional", "Functional"]]}, {"id": "context", "label": "Context", "type": "text", "value": "Product feature screenshot"}], "manual": false}, "batch-keyboard-checklist": {"title": "Batch Keyboard Navigation Checklist", "desc": "Generate a keyboard navigation test checklist. Use this focused variant for batch workflows and long-tail search scenarios.", "category": "Interaction", "kind": "keyboardChecklist", "fields": [{"id": "page", "label": "Page or component name", "type": "text", "value": "Pricing page"}], "manual": false}};
